...
$page_title = "EduScore - Manajemen Kelas";
    ...
    <div class="max-w-5xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        <div class="flex items-center gap-2">
            ...
            <div class="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-on-primary hidden md:flex">
                <span class="material-symbols-outlined text-sm" style="font-variation-settings: 'FILL' 1;">meeting_room</span>
            </div>
            <span class="font-headline font-bold text-primary tracking-tight text-lg">EduScore</span>
            <span class="text-on-surface-variant ml-2 text-sm font-medium hidden md:block">| Manajemen Kelas</span>
        </div>
...
<main class="flex-grow max-w-5xl mx-auto w-full p-4 md:p-6 flex flex-col gap-6">
    <div>
        <h1 class="text-2xl md:text-3xl font-bold tracking-tight text-primary mb-1">Daftar Kelas</h1>
                ...
                <tbody class="text-sm text-on-surface divide-y divide-outline-variant/10">
                    ...
                    <tr class="bg-primary/5 border-t-2 border-primary/20">
                        <form action="proses_kelas.php" method="POST">
                            ...
                            <td class="px-6 py-3">
                                <select name="jenjang" class="w-full bg-surface-container-lowest border-0 border-b-2 border-primary focus:ring-0 text-xs font-bold py-2" required>
                                    <option value="SMP">SMP</option>
                                    <option value="SMA">SMA</option>
                                </select>
                            </td>
                            <td class="px-6 py-3">
                                <input type="text" name="nama_kelas" required class="w-full bg-surface-container-lowest border-0 border-b-2 border-primary focus:ring-0 px-2 py-2 text-sm font-bold text-primary placeholder-primary/30" placeholder="Contoh: 10 IPA 1">
                            </td>
